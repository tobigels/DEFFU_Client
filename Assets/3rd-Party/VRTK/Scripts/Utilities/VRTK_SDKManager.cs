...
namespace VRTK
{
    ...
    public sealed class VRTK_SDKManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// The event fired when a Setup has been successfully loaded
        /// </summary>
        public delegate void SetupFinished();
        public static event SetupFinished OnSetupFinished;
...
#pragma warning restore 618
        ...
        private IEnumerator FinishSDKSetupLoading(VRTK_SDKSetup[] sdkSetups, VRTK_SDKSetup previousLoadedSetup)
        {
            ...
            //Event when everything has been loaded correctly
