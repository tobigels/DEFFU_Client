...
public class ControllerEventsExtension : VRTK_ControllerEvents {
    ...
    public void FireButtonEvents(bool[] buttonPushStatus, bool[] buttonTouchStatus, bool isRight) {
        ...
        if (buttonPush[0] != buttonPush_previous[0]) {
            if(buttonPush[0]) {
                //ButtonOne Pressed
                Debug.Log("Button One pressed " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
                ...
                //ButtonOne Released
                Debug.Log("Button One released " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
        ...
        if (buttonPush[1] != buttonPush_previous[1]) {
            if (buttonPush[1]) {
                //ButtonTwo Pressed
                Debug.Log("Button Two pressed " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
                ...
                //ButtonTwo Released
                Debug.Log("Button Two released " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
        ...
        if (buttonPush[2] != buttonPush_previous[2]) {
            if (buttonPush[2]) {
                //Trigger Pressed
                Debug.Log("Trigger pressed " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
        ...
        if (buttonPush[3] != buttonPush_previous[3]) {
            if (buttonPush[3]) {
                //Grip Pressed
                Debug.Log("Grip pressed " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
        ...
        if (buttonPush[4] != buttonPush_previous[4]) {
            if (buttonPush[4]) {
                //Touchpad Pressed
                Debug.Log("Thumbstick pressed " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
                ...
                //Touchpad Released
                Debug.Log("Thumbstick released " + PlayerManager.instance.globalTime + " I " + PlayerManager.instance.GameTurn);
